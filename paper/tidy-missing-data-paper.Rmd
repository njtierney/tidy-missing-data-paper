...
(principle: clarity of labelling - transparent what the matrix means, because these could equally be "missing" or "present" - for this. Anybody looking at these values)
...
Other statistical programs (SPSS, SAS, and Stata) represent missingness values as a full-stop, `.`, and allow for recording special missing values as `.a` - `.z`. 

SAS, SPSS, and STATA all implement 
...
(discuss the principles, rather than what we've done)

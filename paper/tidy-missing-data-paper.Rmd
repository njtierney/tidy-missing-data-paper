...
One drawback to imputation functions in this form is that the location of imputed values is not tracked. This issue is resolved with \code{nabular} data covered in Section \@ref(verbs-track).

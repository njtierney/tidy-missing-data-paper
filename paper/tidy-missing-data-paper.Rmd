...
1. **Cohesiveness**: Binding the shadow matrix column-wise to the original data creates a cohesive _nabular_ data format, so that it cannot be out of sync with the data. useful for visualization, summaries, and tracking imputed values. This is discussed in more detail below in \@ref(nabular-data).

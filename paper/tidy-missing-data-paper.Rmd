...
with visualizations, summaries, and modelling. This exploratory process
is iterative, and often soaks up a lot of time before more pertinent questions
can be answered.

Understanding the missing data mechanism is an iterative procedure, to arrive at a reasonably confident state of understanding the missing data mechanism.

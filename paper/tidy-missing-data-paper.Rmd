...
The acronym MANET [@Unwin1996] stands for "Missings Are Now Equally Treated". Missing values are often ignored when plotting data, but  plots can help to reveal the type of missing values patterns existing in the data, and even help to assess whether the fall into the MCAR, MAR or even MNAR labels.

Here we summarise systematically exploring the missing patterns visually, and define  useful plots to make relative to the nabular  data structure.

...
The imputation literature (See \@ref(imputation)) focusses on ensuring valid statistical inference
...
While there have been many software tools for exploring missing data (See \@ref(exploration)), these tools do not integrate easily into analysis pipelines. Despite it being crucial to explore and understand missing data, there is very little research on how to make this process more efficient and integrate it into the analysis pipeline. The analyst must
